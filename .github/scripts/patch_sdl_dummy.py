...
static void mister_present(SDL_Surface *screen) {
    ...
    *mister_ctrl = (mister_frame_cnt << 2) | (mister_active_buf & 1);
     ...
     * Writes SDL surface as RGB888 PPM to /media/fat/logs/OpenBOR_7533/
     * captures/cap_NNN.ppm every 120 frames (2s @ 60fps), up to 600
     * captures = 20 minutes of gameplay coverage. After that, stops.
     * Compare across builds (4086 + 7533) to find the actual color diff.
     * Per user request 2026-05-18 for A Tale of Vengeance palette bug
     * (Hugo + girls; Hugo appears 5-10 min into gameplay).
     */
    {
