...
#define COPY_ROOT_PATH(buf, name) strcpy(buf, "./"); strcat(buf, name); strcat(buf, "/");
    ...
    if not HEADLESS:
        ...
        ob = strict_replace(
            ...
            "    unsigned int cont = 0; unsigned short ic = 0, nl = 0; char nm[512];\n"
            "    f = fopen(path, \"rb\");\n"
            ...
            "    if(ic == 0){ fclose(f); return 1; }   /* pre-v2 take: unverifiable, still plays */\n"
        ...
        rec_arm_new = rec_arm_anchor + "\n" + (
            ...
            "                      (void)_mr_miss; (void)_mr_i; _mr_mx = mrec_highest(_mr_nm); } /* bounded 1..MREC_SLOTS -- see mrec_highest */\n"
            ...
            "                           && _mr_cv==2u   /* container version; a mismatch is reported below, not treated as corruption. v2 adds the identity section: content hash + recorder save stem. */\n"
