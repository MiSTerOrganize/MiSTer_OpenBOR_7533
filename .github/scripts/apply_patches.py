...
#define COPY_ROOT_PATH(buf, name) strcpy(buf, "./"); strcat(buf, name); strcat(buf, "/");
    ...
    arr_print_new = (
        ...
        "                }\n"
        "                {\n"
        "                    static const char *_bn[8] = {\"opaque\",\"SCREEN\",\"MULTIPLY\",\"OVERLAY\",\"HARDLIGHT\",\"DODGE\",\"HALF\",\"alpha>6\"};\n"
    ...
    spr = strict_replace(
        ...
        "            int _a = drawmethod->alpha;   /* SIGNED -- alpha <= 0 is opaque */\n"
        "            unsigned int _i = (_a <= 0) ? 0u : ((_a <= 6) ? (unsigned int)_a : 7u);\n"
