...
=======
            ...
            "                      memset(_mr_bd,0,12); strncpy(_mr_bd, " + _MREC_BUILD_EXPR + ", 11);\n"
...
>>>>>>> Stashed changes
            ...
            "                    fwrite(\"MREC4\",1,5,_mr_wf);\n"
            "                    fwrite(&_mr_ev,sizeof(unsigned int),1,_mr_wf);\n"
            "                    memset(_mr_bd,0,12); strncpy(_mr_bd, __DATE__, 11); fwrite(_mr_bd,1,12,_mr_wf);\n"
            "                    memset(_mr_pk,0,128); strncpy(_mr_pk, _mr_nm, 127); fwrite(_mr_pk,1,128,_mr_wf);   /* PAK identity (getPakName base, stripped) -- checked on playback */\n"
            "                    fwrite(&_mr_seed,sizeof(unsigned long),1,_mr_wf);\n"
            "                    fwrite(&_mr_len,sizeof(long),1,_mr_wf);\n"
            "                    if(_mr_len>0 && _mr_buf) fwrite(_mr_buf,9*sizeof(u64),(size_t)_mr_len,_mr_wf);\n"
            "                    fclose(_mr_wf); } }\n"
            "                if(_mr_buf){free(_mr_buf);_mr_buf=NULL;} _mr_cap=0; _mr_len=0;\n"
            "                mrec_mode = 0;\n"
            "            }\n"
